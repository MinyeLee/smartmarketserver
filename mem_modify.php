...
<?php 
    ...
    <div class='container'>
        <div class='row'>
            <form  method='post' action='mem_modify_post.php'>
                <div class='col-lg-6'>
                    <div class='well well-sm'><strong><span class='glyphicon glyphicon-asterisk'></span>필수 입력란</strong></div>
                    <div class='form-group'>
                        <label for='name'>아이디</label>
                        <div class='well well-sm'><strong><span class='glyphicon glyphicon-asterisk'></span>아이디는 수정할 수 없습니다</strong></div>
                    </div>
                    <div class='form-group'>
                        <label for='pw'>비밀번호</label>
                        <div class='input-group'>
                            <input type='password' class='form-control' id='pw' name='pw' value = '$row[pw]' required>
                    ...
                    <div class='form-group'>
                        ...
                        <div class='input-group'>
                            <input type='password' class='form-control' id='pw_check' name='pw_check' value = '$row[pw_check]' required>
                            <span class='input-group-addon'><span class='glyphicon glyphicon-asterisk'></span></span>
                        </div>
                    </div>
                    <div class='form-group'>
                        ...
                        <div class='input-group'>
                            <input type='text' class='form-control' name='nickname' id='nickname' value='$row[nickname]' required>
                            <span class='input-group-addon'><span class='glyphicon glyphicon-asterisk'></span></span>
                        </div>
                    </div>
                    <div class='form-group'>
                   ...
                   <label class='radio-inline'>
                    ...
                    <div class='form-group'>
                        ...
                        <div class='input-group'>
                            <input type='text' class='form-control' id='addr' name='addr' value = '$row[addr]'>
                            <span class='input-group-addon'></span>
                        </div>
                    </div>
                    <div class='form-group'>
                   ...
                   <label class='radio-inline'>
                    ...
                    <input type='reset' name='cancel' id='submit' value='취소' class='btn btn-info pull-right'>         
                    <input type='submit' name='submit' id='submit' value='수정하기' class='btn btn-info pull-right'>                
                </div>
            </form>        
        </div>
    </div>";?>
