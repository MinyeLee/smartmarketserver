...
<!-- Signin form - START -->
    <div class="container">
      ...
      <form method="post" action="login.php" class="form-signin">
        ...
        <input type="id" name="id" class="form-control" placeholder="아이디" required autofocus><br>

        <label for="pw" class="sr-only">Password</label>
        <input type="password" name="pw" class="form-control" placeholder="패스워드" required>

        <div class="checkbox">
          <label>
            <input type="checkbox" value="remember-me"> 아이디를 기억합니다
          </label>
        </div>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<a href="./mem_form.php"><button type="submit">회원가입</button></a>
