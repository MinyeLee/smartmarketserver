 ...
 <div class="container">
      <div class="blog-header">
        ...
        <p class="lead blog-description"></p>
          ...
          <div class="blog-post">
            <h2 class="blog-post-title">관리자페이지</h2>
    ...
    mysql_select_db($dbname) or die ('Couldn\'t open the database $dbname');
            ...
            $my_order = "DELETE FROM mpk where id='$_GET[id]'";
            $my_result = mysql_query($my_order);

            $re=mysql_query("SELECT * FROM mpk limit $start,10");
            ...
            while($result=mysql_fetch_array($re))
            {
                echo ("
                  <tr>
                    ...
                    <td><a data-toggle='modal' class='btn btn-default' href='remote.php?id=$result[id]' data-target='#myModal'>상세 설명</a></td>
                    <td>$result[checkinfo]</td>
                    <td><a class='btn btn-primary' href='./administrator.php?id=$result[id]'>삭제</a></td>
                  </tr>
                  ");
                $number++;
            }
      ...
      <div class = "centre">
          ...
          <ul class="pagination">
            ...
            <li><a href="administrator.php?page=1" style="text-decoration:none">1</a></li>
            <li><a href="administrator.php?page=2" style="text-decoration:none">2</a></li>
            <li><a href="administrator.php?page=3" style="text-decoration:none">3</a></li>
            <li><a href="administrator.php?page=4" style="text-decoration:none">4</a></li>
            <li><a href="administrator.php?page=5" style="text-decoration:none">5</a></li>
            <li>
