      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
          ...
          mysql_select_db($dbname) or die ('Couldn\'t open the database $dbname');
            ...
            $sql = mysql_query("SELECT * FROM mpk WHERE name LIKE '%$_GET[term]%'");
            
            while($my_result=mysql_fetch_array($sql))
            {
                echo ("
                  <div class='col-xs-6 col-lg-4'>
                  <br><br>
                  <p><img src = '$my_result[icon]' width = 200 height =200 class='img-rounded'></p>
                  <h4>$my_result[name]</h4>
                  <p><a class='btn btn-default'  data-backdrop='static' href='remote_store.php?id=$my_result[id]' role='button' data-toggle='modal' data-target='#myModal'>View details &raquo;</a></p>
                  </div>
                  ");
            }    
        ...
        <form method ='gett' action='./store_search.php'>
