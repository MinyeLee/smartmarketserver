...
<body>
  <?php
    ...
    mysql_select_db($dbname) or die ('Couldn\'t open the database $dbname');
      $order = "SELECT * FROM mpk where name='$_GET[name]'";
            ...
            <form method='POST' action = './administrator.php' >
             <p style = 'float:left'><img STYLE='margin-left: 60px; margin-right: 50px; margin-top: 40px; WIDTH:250px; HEIGHT:250px ' src='$row[icon]' class='img-rounded' alt='IMG not registered'></p>
                  ...
                  <div>
                    ...
                    <p style = 'float:left'>
                      <img STYLE='margin-left: 40px; margin-top: 20px; WIDTH:150px; HEIGHT:250px ' src='$row[img1]'class='img-rounded' alt='IMG not registered'>
                      <img STYLE='margin-left: 10px; margin-top: 20px; WIDTH:150px; HEIGHT:250px 'src='$row[img2]'class='img-rounded' alt='IMG not registered'>
                      <img STYLE='margin-left: 10px; margin-top: 20px; WIDTH:150px; HEIGHT:250px 'src='$row[img3]' class='img-rounded' alt='IMG not registered'>
                      <img STYLE='margin-left: 10px; margin-top: 20px; WIDTH:150px; HEIGHT:250px ' src='$row[img4]'class='img-rounded' alt='IMG not registered'>
                      <img STYLE='margin-left: 10px; margin-top: 20px; WIDTH:150px; HEIGHT:250px '' src='$row[img5]'class='img-rounded' alt='IMG not registered'>
                  </p>
